...
function Input(s,headid)
	...
	local hz={};
	local yesno={
					x1=CC.ScreenW/2-108;	--背景栏x	276
					y1=CC.ScreenH-81;		--背景栏y	351
	...
	local str=s;
	local py="";
	local cx,cy=400,320;	--虚拟键盘左上角
	local hz_left,hz_top,hz_right,hz_bottom=414,100,0,0;
	local size=20;
	local HZ={
			de={"的","地","得","德","底"},
			di={"的","地","第","提","低","底","抵","弟","迪","递","帝","敌","堤","蒂","缔","滴","涤","翟","娣","笛","棣","荻","谛","狄","邸","嘀","砥","坻","诋","嫡","镝","碲","氐","柢","绨","籴","羝","睇","觌"},
			yi={"一","以","已","意","议","义","益","亿","易","医","艺","依","移","衣","异","伊","仪","宜","遗","疑","毅","谊","亦","疫","役","忆","抑","乙","译","翼","溢","椅","沂","逸","蚁","夷","邑","怡","绎","彝","裔","姨","熠","贻","矣","屹","颐","倚","诣","胰","奕","翌","弈","轶","驿","壹","猗","臆","弋","铱","旖","漪","迤","佚","翊","诒","怿","痍","懿","饴","峄","揖","眙","镒","仡","黟","肄","咿","翳","挹","缢","呓","刈","咦","嶷","羿","钇","殪","荑","薏","蜴","镱","噫","苡","悒","嗌","瘗","欹","佾","埸","圯","舣","酏","劓"},
			...
			shi={"是","市","时","实","事","十","使","世","施","式","势","视","识","师","史","示","石","食","始","士","失","适","试","什","室","似","诗","饰","殖","释","驶","氏","逝","湿","蚀","狮","誓","拾","尸","匙","仕","柿","矢","峙","侍","噬","嗜","拭","嘘","屎","恃","轼","虱","舐","莳","铈","谥","豕","鲥","螫","酾","筮","埘","蓍","贳"},
			nian={"年","念","酿","粘","碾","廿","捻","撵","拈","蔫","鲶","辇","黏"},
			he={"和","合","河","何","核","贺","喝","赫","荷","盒","鹤","吓","呵","禾","菏","壑","褐","涸","阂","阖","劾","诃","颌","貉","曷","翮","纥","蚵","盍"},
			hu={"和","护","户","核","湖","互","乎","呼","胡","戏","忽","虎","沪","糊","壶","葫","狐","蝴","弧","瑚","浒","鹄","琥","扈","唬","滹","惚","祜","囫","斛","笏","醐","猢","怙","戽","槲","觳","糊","鹕","冱","瓠","岵"},
			huo={"和","活","或","货","获","火","伙","惑","霍","祸","豁","藿","蠖","钬","镬","夥","攉"},
			da={"大","达","打","答","塔","搭","沓","瘩","嗒","哒","耷","鞑","疸","靼","褡","笪","怛","妲"},
			dai={"大","代","带","待","贷","戴","袋","歹","呆","逮","岱","傣","怠","殆","黛","埭","绐","玳","呔","迨","骀"},
			ye={"业","也","夜","叶","野","液","冶","页","爷","耶","邪","咽","椰","哗","烨","掖","拽","曳","晔","谒","腋","噎","揶","靥","邺"},
			bu={"不","部","步","布","补","捕","堡","埔","卜","埠","簿","哺","怖","瓿","逋","晡","醭","钸"},
			wei={"为","位","委","未","维","卫","围","违","威","伟","危","味","微","遗","唯","谓","伪","慰","尾","魏","韦","胃","畏","帷","喂","巍","萎","蔚","纬","潍","尉","渭","惟","薇","苇","炜","圩","娓","诿","玮","崴","桅","偎","逶","猥","囗","葳","隗","痿","猬","涠","嵬","韪","煨","艉","帏","闱","洧","沩","隈","鲔"},
			fa={"发","法","罚","乏","伐","阀","筏","砝","珐"},
			...
			jing={"经","京","精","境","竞","景","警","竟","井","惊","径","静","劲","敬","净","镜","睛","晶","荆","兢","靖","泾","憬","鲸","茎","菁","胫","阱","旌","粳","靓","痉","儆","婧","刭","弪","獍"},
			shang={"上","商","尚","伤","赏","汤","裳","晌","垧","觞","殇","熵"},
			yao={"要","约","药","邀","陶","摇","耀","腰","遥","姚","窑","瑶","咬","尧","钥","谣","肴","夭","侥","吆","疟","妖","杳","舀","窈","曜","鹞","爻","繇","徭","轺","铫","鳐","珧"},
			...
			chu={"出","处","础","初","除","储","畜","触","楚","厨","雏","矗","橱","锄","褚","滁","躇","怵","绌","搐","刍","蜍","黜","杵","蹰","亍","樗","楮"},
			...
			ri={"日"},
			min={"民","敏","闽","闵","皿","泯","岷","悯","抿","黾","缗","玟","愍","苠"},
			lai={"来","莱","赖","睐","徕","籁","涞","赉","濑","癞","崃","铼"},
			wo={"我","握","窝","沃","卧","挝","涡","斡","渥","幄","蜗","喔","倭","莴","龌","硪"},
			dui={"对","队","敦","兑","堆","碓","怼","憝"},
			jin={"进","金","今","近","仅","紧","尽","津","斤","禁","锦","劲","晋","谨","筋","巾","浸","襟","靳","瑾","烬","缙","觐","堇","馑","荩","噤","廑","妗","槿","赆","衿","卺"},
			duo={"多","度","夺","朵","躲","铎","咄","堕","舵","驮","垛","惰","哆","踱","跺","掇","剁","柁","缍","裰"},
			quan={"全","权","券","泉","圈","拳","劝","犬","铨","痊","诠","荃","醛","蜷","颧","绻","筌","鬈","悛","辁","畎"},
			jian={"建","间","件","见","坚","检","健","监","减","简","艰","践","兼","鉴","键","渐","柬","剑","尖","肩","舰","荐","箭","浅","剪","俭","碱","茧","奸","歼","拣","捡","煎","贱","溅","槛","涧","笺","谏","饯","锏","缄","睑","謇","蹇","腱","菅","翦","戬","毽","笕","犍","鞯","牮","湔","鲣","囝","搛","缣","鹣","蒹","谫","僭","戋","趼","楗"},
			ta={"他","它","她","拓","塔","踏","塌","榻","沓","漯","獭","嗒","挞","蹋","趿","遢","铊","鳎","闼"},
			kai={"开","凯","慨","楷","恺","揩","锴","铠","忾","垲","剀","锎"},
			men={"们","门","闷","扪","焖","懑","钔"},
			chang={"场","长","厂","常","偿","昌","唱","畅","倡","尝","肠","敞","倘","猖","娼","裳","徜","昶","怅","嫦","菖","鲳","阊","伥","苌","氅","惝","鬯"},
			zhan={"展","战","占","站","崭","粘","湛","沾","瞻","颤","詹","斩","盏","辗","绽","毡","栈","蘸","旃","谵","搌"},
			li={"理","力","利","立","里","李","历","例","离","励","礼","丽","黎","璃","厉","厘","粒","莉","梨","隶","栗","荔","沥","犁","漓","哩","狸","藜","罹","篱","鲤","砺","吏","澧","俐","骊","溧","砾","莅","锂","笠","蠡","蛎","痢","雳","俪","醴","栎","郦","俚","枥","喱","逦","娌","鹂","戾","唳","坜","疠","蜊","黧","猁","鬲","粝","蓠","呖","跞","疬","缡","鲡","鳢","嫠","詈","悝","苈","篥","轹"},
			...
			qi={"企","其","起","期","气","七","器","汽","奇","齐","启","旗","棋","妻","弃","歧","欺","骑","契","迄","亟","漆","戚","岂","稽","岐","琦","栖","缉","琪","泣","乞","砌","祁","崎","绮","祺","蹊","祈","凄","淇","杞","脐","麒","圻","岖","憩","俟","畦","荠","耆","葺","沏","萋","骐","鳍","綦","讫","蕲","屺","颀","亓","碛","柒","汔","綮","萁","嘁","蛴","槭","欹","芑","桤","蜞"},
			zi={"资","自","子","字","咨","滋","仔","姿","紫","兹","孜","淄","籽","梓","鲻","渍","姊","吱","秭","恣","孳","訾","滓","锱","辎","趑","龇","赀","眦","缁","呲","笫","嵫","髭","茈","粢","觜","耔"},
			...
			ji={"济","机","其","技","基","记","计","系","革","期","际","及","集","级","几","给","积","极","己","纪","即","继","击","既","激","绩","急","奇","吉","季","齐","疾","迹","鸡","剂","辑","籍","寄","挤","圾","冀","亟","寂","暨","脊","跻","肌","稽","忌","饥","祭","缉","棘","矶","汲","畸","姬","藉","瘠","骥","羁","妓","讥","稷","蓟","悸","嫉","岌","叽","伎","鲫","诘","楫","荠","戟","箕","霁","嵇","觊","麂","畿","玑","笈","犄","芨","唧","屐","髻","戢","佶","偈","笄","跽","蒺","乩","咭","赍","虮","掎","齑","殛","鲚","剞","洎","丌","墼","蕺","芰","哜"},
			yong={"用","永","拥","勇","涌","泳","庸","俑","踊","佣","咏","雍","甬","镛","臃","邕","蛹","恿","慵","壅","痈","墉","饔","喁"},
			tong={"同","通","统","童","痛","铜","桶","桐","筒","彤","侗","佟","潼","捅","酮","瞳","恸","峒","仝","恫","垌","茼"},
			yu={"于","与","育","余","预","域","予","遇","语","誉","玉","鱼","雨","渔","裕","谷","愈","娱","欲","吁","舆","宇","羽","逾","豫","郁","寓","狱","喻","御","浴","愉","禹","俞","蔚","榆","愚","渝","尉","淤","虞","屿","峪","粥","驭","瑜","禺","毓","钰","隅","芋","熨","瘀","迂","煜","昱","於","臾","盂","聿","竽","萸","妪","腴","圄","谕","觎","揄","龉","谀","俣","餘","庾","妤","瘐","鬻","欤","腧","鹬","阈","嵛","雩","鹆","菀","圉","蜮","伛","纡","窬","窳","饫","蓣","狳","舁","蝓","燠"},
			gao={"高","告","搞","稿","膏","糕","镐","皋","羔","锆","杲","郜","睾","诰","篙","缟","槁","槔"},
			zhang={"长","张","章","障","涨","掌","帐","胀","彰","丈","仗","漳","樟","账","杖","璋","嶂","仉","瘴","蟑","獐","幛","鄣","嫜"},
			xian={"现","先","县","见","线","限","显","险","献","鲜","洗","宪","纤","陷","闲","贤","仙","衔","掀","咸","嫌","羡","弦","腺","痫","娴","舷","馅","酰","铣","冼","涎","暹","籼","苋","蚬","跹","岘","藓","燹","鹇","氙","莶","霰","跣","猃","祆","筅"},
			ben={"本","奔","苯","笨","夯","贲","锛","畚","坌"},
			yue={"月","说","约","越","乐","跃","阅","岳","粤","悦","曰","钥","栎","钺","樾","瀹","龠","刖"},
			ding={"定","订","顶","丁","鼎","盯","钉","锭","叮","仃","铤","町","酊","啶","碇","疔","玎","耵"},
			hua={"化","华","划","话","花","画","滑","哗","豁","骅","桦","猾","铧","砉"},
			dong={"动","东","董","冬","洞","懂","冻","栋","侗","咚","峒","氡","恫","胴","硐","垌","鸫","岽"},
			pin={"品","贫","聘","频","拼","苹","拚","颦","姘","嫔","牝"},
			chong={"重","种","充","冲","涌","崇","虫","宠","忡","憧","舂","茺","铳","艟"},
			guan={"关","管","观","馆","官","贯","冠","惯","灌","罐","莞","纶","棺","矜","倌","鹳","鳏","盥","掼","涫"},
			fen={"分","份","纷","奋","粉","氛","芬","愤","粪","坟","汾","焚","酚","吩","忿","棼","玢","鼢","瀵","偾"},
			wai={"外","歪"},
			qu={"区","去","取","且","曲","趋","渠","趣","驱","屈","躯","衢","娶","祛","瞿","戌","岖","龋","觑","朐","蛐","癯","蛆","苣","阒","诎","劬","蕖","蘧","氍","蠼","璩","麴","鸲","磲"},
			ou={"区","欧","偶","殴","呕","藕","讴","鸥","瓯","沤","耦","怄"},
			neng={"能"},
			she={"设","社","摄","涉","射","折","舍","蛇","舌","奢","慑","赦","赊","佘","麝","歙","畲","厍","摺","猞","滠"},
			hou={"后","候","厚","侯","猴","喉","吼","逅","篌","糇","後","鲎","瘊","堠"},
			jiu={"就","究","九","酒","久","救","旧","纠","舅","灸","疚","揪","咎","韭","玖","臼","柩","赳","鸠","鹫","厩","啾","阄","僦"},
			deng={"等","登","邓","灯","澄","凳","瞪","蹬","磴","嶝","镫","簦","戥"},
			...
			mo={"万","无","没","模","末","冒","莫","摩","墨","默","磨","摸","漠","脉","膜","魔","沫","陌","抹","寞","蘑","摹","蓦","馍","茉","嘿","谟","秣","貉","嫫","镆","殁","瘼","貊","貘"},
			yuan={"元","员","院","原","源","远","愿","园","援","圆","缘","袁","怨","渊","苑","冤","媛","猿","垣","沅","垸","鸳","辕","鸢","瑗","圜","爰","芫","鼋","橼","螈","眢","掾"},
			qian={"前","千","钱","签","潜","迁","欠","纤","牵","浅","遣","谦","乾","铅","歉","黔","谴","嵌","倩","钳","茜","虔","堑","骞","阡","掮","钤","扦","芊","犍","箬","荨","仟","芡","悭","缱","佥","愆","褰","岍","搴","箝","慊","椠"},
			...
			ke={"可","科","克","客","刻","课","颗","渴","壳","柯","棵","呵","坷","恪","苛","咳","磕","珂","稞","瞌","溘","轲","窠","嗑","蝌","岢","颏","髁","缂","氪","骒","钶","锞"},
			zong={"总","综","宗","纵","踪","棕","粽","鬃","偬","枞"},
			gai={"改","该","盖","概","溉","钙","丐","芥","赅","垓","陔","戤"},
			san={"三","散","伞","糁","毵"},
			hao={"好","号","毫","豪","耗","浩","郝","皓","昊","镐","蒿","壕","灏","嚎","濠","蚝","貉","颢","嗥","薅","嚆"},
			si={"司","四","思","斯","食","私","死","似","丝","饲","寺","厕","肆","撕","泗","伺","嗣","祀","厮","驷","嘶","锶","俟","巳","蛳","咝","耜","笥","鸶","缌","澌","姒","汜","兕"},
			cong={"从","丛","匆","聪","葱","囱","琮","淙","骢","苁"},
			ping={"平","评","凭","瓶","冯","屏","萍","苹","乒","坪","枰","娉","俜"},
			dang={"当","党","档","荡","挡","宕","砀","裆","菪","谠"},
			tian={"天","田","添","填","甜","恬","腆","佃","舔","阗","忝","殄","畋","掭"},
			nei={"内","那","哪","馁"},
			xiao={"小","效","销","消","校","晓","笑","肖","削","孝","萧","潇","硝","宵","啸","嚣","霄","淆","哮","筱","逍","箫","骁","枭","哓","绡","蛸","崤","枵","魈"},
			mu={"目","模","木","亩","幕","母","牧","穆","姆","墓","慕","牟","牡","募","睦","沐","暮","拇","姥","钼","苜","坶"},
			hai={"海","还","害","孩","亥","咳","骸","嘿","骇","氦","嗨","胲","醢"},
			suo={"所","索","缩","锁","莎","梭","琐","嗦","唆","唢","娑","蓑","羧","挲","桫","嗍"},
			ru={"入","如","乳","儒","辱","汝","茹","褥","孺","濡","蠕","嚅","缛","溽","铷","洳","薷","襦","蓐"},
			liang={"量","两","粮","良","辆","亮","梁","凉","谅","粱","晾","靓","踉","莨","椋","魉",},
			du={"度","都","独","督","读","顿","毒","渡","杜","堵","赌","睹","肚","镀","渎","笃","嘟","犊","妒","牍","蠹","椟","黩","芏","髑"},
			bei={"北","被","备","倍","背","杯","贝","辈","悲","碑","臂","卑","悖","惫","蓓","陂","钡","狈","呗","焙","碚","褙","埤","鞴","孛","鹎","萆","邶"},
			huan={"还","环","换","欢","患","缓","唤","焕","幻","痪","桓","寰","涣","宦","洹","浣","豢","奂","郇","圜","獾","鲩","鬟","萑","逭","漶","锾","缳","擐"},
			dou={"都","斗","读","豆","抖","兜","陡","逗","窦","蚪","痘"},
			shu={"术","书","数","属","树","输","束","述","署","熟","殊","蔬","舒","疏","鼠","淑","叔","暑","枢","墅","俞","曙","抒","竖","蜀","薯","梳","戍","恕","孰","沭","赎","庶","漱","塾","倏","澍","纾","姝","菽","黍","腧","秫","毹","殳","摅"},
			...
			ci={"次","此","词","辞","刺","瓷","磁","兹","慈","茨","赐","祠","伺","雌","疵","鹚","呲","茈"},
			jiang={"将","强","江","奖","讲","降","疆","蒋","姜","浆","匠","酱","僵","桨","绛","缰","豇","礓","洚","茳","糨","耩"},
			qiang={"将","强","抢","墙","枪","腔","锵","呛","羌","蔷","襁","羟","跄","樯","戕","嫱","戗","炝","镪","锖","蜣"},
			zeng={"增","曾","综","赠","憎","甑","罾","缯"},
			...
			mei={"美","没","每","煤","梅","媒","枚","妹","眉","魅","霉","谜","昧","媚","玫","镁","湄","寐","莓","袂","楣","糜","嵋","镅","浼"},
			...
			xi={"系","西","席","息","希","习","吸","喜","细","析","戏","洗","悉","锡","溪","惜","稀","袭","夕","晰","昔","牺","腊","烯","熙","媳","栖","膝","隙","犀","蹊","硒","兮","熄","曦","禧","茜","嬉","玺","奚","汐","徙","羲","铣","淅","嘻","歙","熹","矽","蟋","郗","唏","皙","隰","樨","浠","蜥","檄","翕","阋","屣","葸","螅","粞","觋","欷","僖","醯","鼷","裼","穸","饩","舄","禊","菥","蓰"},
			ban={"办","版","半","班","般","板","颁","伴","搬","斑","扮","拌","扳","瓣","坂","阪","绊","钣","瘢","舨"},
			jiao={"教","交","较","校","角","觉","叫","脚","缴","胶","轿","郊","焦","骄","浇","椒","礁","佼","娇","矫","搅","绞","酵","剿","嚼","饺","窖","跤","蛟","侥","狡","姣","皎","茭","峤","铰","醮","鲛","湫","徼","鹪","僬","艽","挢"},
			tiao={"条","调","挑","跳","迢","眺","苕","窕","笤","佻","粜","髫","祧","龆","蜩","鲦"},
			zui={"最","罪","堆","嘴","醉","咀","蕞"},
			te={"特","忑","忒","铽","慝"},
			shou={"收","手","受","首","售","授","守","熟","寿","瘦","兽","狩","绶","艏"},
			bing={"并","病","兵","冰","屏","饼","炳","秉","丙","摒","柄","槟","禀","邴"},
			an={"厂","广","安","案","按","岸","暗","鞍","氨","俺","胺","铵","谙","庵","黯","鹌","桉","埯","犴"},
			kou={"口","扣","寇","叩","抠","蔻","芤","筘"},
			diao={"调","掉","雕","鸟","吊","钓","刁","貂","凋","碉","鲷","叼","铫"},
			zu={"组","族","足","祖","租","阻","卒","俎","诅","镞","菹"},
			lu={"路","率","律","旅","六","陆","录","绿","虑","露","鲁","卢","炉","履","吕","铝","屡","鹿","禄","赂","芦","庐","碌","氯","缕","滤","麓","侣","颅","驴","泸","卤","潞","鹭","辘","榈","虏","璐","漉","噜","闾","褛","戮","鲈","掳","橹","轳","逯","渌","蓼","撸","鸬","栌","氇","胪","簏","膂","舻","辂","稆","垆"},
			guang={"广","光","逛","犷","胱","桄"},
			bi={"比","必","币","笔","毕","秘","避","闭","辟","壁","弊","彼","逼","碧","鼻","臂","蔽","拂","泌","璧","庇","痹","毙","弼","匕","鄙","陛","裨","贲","敝","蓖","篦","俾","铋","毖","筚","荸","薜","婢","哔","跸","埤","濞","秕","荜","愎","睥","妣","芘","箅","庳","髀","畀","滗","狴","萆","嬖","襞"},
			tou={"投","头","透","偷","钭","骰"},
			jue={"决","绝","角","觉","脚","掘","崛","诀","獗","抉","爵","嚼","倔","厥","蕨","攫","珏","矍","蹶","谲","镢","嗟","噱","桷","噘","撅","橛","孓","觖","劂","爝"},
			nan={"南","难","男","楠","喃","囡","赧","腩","囝","蝻"},
			na={"南","那","纳","拿","呢","哪","娜","钠","捺","衲","镎","肭"},
			ling={"领","令","另","零","灵","龄","陵","岭","凌","玲","铃","菱","棱","伶","拎","羚","苓","聆","翎","泠","瓴","囹","绫","呤","棂","蛉","酃","鲮","柃"},
			qing={"情","青","清","请","亲","轻","庆","倾","顷","卿","晴","氢","擎","氰","罄","磬","蜻","箐","鲭","綮","黥","圊","檠","謦"},
			shan={"山","单","善","陕","闪","衫","擅","汕","扇","杉","珊","禅","删","膳","缮","赡","鄯","栅","煽","姗","跚","鳝","嬗","潸","讪","舢","苫","疝","掸","膻","钐","剡","芟","埏","骟"},
			che={"车","彻","撤","尺","扯","澈","掣","坼","砗"},
			ju={"车","局","据","具","举","居","剧","巨","聚","距","句","拒","俱","柜","菊","拘","炬","桔","惧","矩","鞠","驹","锯","踞","咀","瞿","枸","掬","沮","莒","橘","飓","疽","趄","踽","遽","琚","龃","椐","苣","裾","狙","倨","榉","苴","讵","雎","锔","窭","鞫","犋","屦","醵"},
			ran={"然","染","燃","冉","苒","髯","蚺"},
			yin={"因","引","银","印","音","烟","饮","阴","隐","姻","殷","淫","尹","荫","吟","瘾","寅","茵","圻","垠","鄞","湮","蚓","氤","胤","龈","窨","喑","铟","洇","狺","夤","霪","堙"},
			ba={"把","八","巴","拔","吧","坝","爸","霸","罢","芭","跋","扒","叭","靶","疤","笆","耙","粑","灞","钯","捌","菝","魃","茇"},
			...
			fu={"府","服","副","负","富","复","福","夫","妇","幅","付","扶","父","符","附","腐","赴","佛","浮","覆","辅","傅","伏","抚","赋","辐","腹","弗","肤","阜","袱","缚","甫","氟","斧","孚","敷","俯","拂","俘","咐","腑","孵","芙","涪","釜","脯","茯","馥","绂","讣","罘","麸","蝠","匐","芾","蜉","跗","凫","滏","蝮","驸","绋","蚨","砩","桴","赙","菔","趺","苻","拊","鲋","怫","稃","郛","莩","幞","祓","艴","黻","黼","鳆"},
			...
			yo={"育","哟","唷"},
			gan={"干","感","赶","敢","甘","肝","杆","赣","乾","柑","尴","竿","秆","橄","矸","淦","酐","绀","泔","坩","旰","疳","澉"},
			tuan={"团","湍","抟","彖"},
			zao={"造","早","遭","枣","噪","灶","燥","糟","凿","躁","藻","皂","澡","蚤"},
			lian={"联","连","练","廉","炼","脸","莲","恋","链","帘","怜","涟","敛","琏","镰","濂","楝","鲢","殓","潋","裢","裣","奁","蠊","蔹"},
			...
			tai={"台","太","态","泰","抬","胎","汰","钛","苔","薹","跆","邰","鲐","呔","骀","炱"},
			yang={"样","养","央","阳","洋","扬","杨","羊","氧","仰","秧","痒","漾","疡","泱","殃","恙","鸯","徉","佯","怏","炀","烊","鞅","蛘"},
			lao={"老","劳","落","络","牢","捞","涝","烙","姥","佬","崂","唠","酪","潦","痨","醪","铑","铹","栳"},
			liu={"流","刘","六","留","陆","柳","瘤","硫","溜","碌","浏","榴","琉","馏","遛","鎏","骝","绺","镏","旒","鹨"},
			hen={"很","狠","恨","痕"},
			gei={"给"},
			chuang={"创","床","窗","闯","幢","疮","怆"},
			lun={"论","轮","伦","仑","纶","沦","抡","囵"},
			bie={"别","鳖","憋","瘪","蹩"},
			bian={"变","便","边","编","遍","辩","鞭","辨","贬","匾","扁","卞","汴","辫","砭","蝙","弁","窆","笾","煸","褊","碥","忭","缏"},
			feng={"风","丰","封","峰","奉","凤","锋","冯","逢","缝","蜂","枫","疯","讽","烽","俸","沣","酆","葑","唪"},
			pi={"批","否","皮","坏","辟","啤","匹","披","疲","僻","毗","坯","脾","譬","劈","媲","屁","琵","邳","裨","痞","癖","陂","丕","枇","霹","纰","砒","铍","淠","郫","埤","睥","芘","蚍","圮","鼙","罴","蜱","疋","貔","仳","庀","擗","甓","陴"},
			cha={"查","察","差","茶","插","叉","茬","楂","岔","诧","碴","嚓","喳","杈","汊","衩","搽","槎","锸"},
			zha={"查","扎","炸","诈","轧","闸","渣","蜡","咋","乍","榨","楂","札","栅","眨","咤","柞","喳","喋","铡","蚱","吒","砟","痄","哳","齄"},
			lin={"林","临","邻","赁","琳","磷","淋","麟","霖","鳞","凛","遴","蔺","吝","粼","嶙","躏","廪","檩","辚","膦","瞵","懔"},
			zhuai={"转","拽","曳"},
			huai={"划","怀","坏","淮","徊","槐","踝"},
			zhun={"准","屯","谆","肫","窀"},
			xu={"需","许","续","须","序","徐","蓄","畜","虚","吁","绪","叙","旭","恤","墟","栩","絮","圩","婿","戌","胥","嘘","浒","煦","酗","诩","盱","蓿","溆","洫","顼","勖","糈","砉","醑"},
			chuan={"传","川","船","穿","串","喘","椽","舛","钏","遄","氚","舡"},
			gou={"构","购","够","句","沟","狗","钩","勾","苟","垢","枸","篝","佝","媾","诟","岣","彀","缑","笱","觏","遘"},
			...
			zhou={"州","周","洲","舟","骤","轴","昼","宙","粥","皱","肘","咒","帚","胄","绉","纣","妯","啁","诌","繇","碡","籀","酎"},
			que={"确","却","缺","雀","鹊","阙","瘸","榷","炔","阕","悫"},
			mao={"贸","毛","矛","冒","貌","茂","茅","帽","猫","髦","锚","懋","袤","牦","卯","铆","耄","瑁","蟊","茆","旄","泖","昴","瞀"},
			fan={"反","范","犯","繁","饭","泛","翻","凡","返","番","贩","烦","帆","樊","藩","矾","梵","蕃","钒","幡","畈","蘩","蹯","燔"},
			xuan={"选","宣","券","旋","悬","轩","喧","玄","绚","渲","璇","炫","萱","癣","漩","眩","暄","铉","楦","泫","谖","揎","儇"},
			ya={"亚","压","雅","牙","押","匹","鸭","呀","涯","崖","芽","哑","讶","鸦","娅","衙","丫","蚜","垭","伢","氩","桠","琊","揠","睚","迓","岈","砑"},
			me={"么"},
			ma={"么","马","吗","摩","麻","码","妈","玛","嘛","骂","抹","蚂","唛","蟆","杩","嬷"},
			wang={"王","望","往","网","忘","亡","旺","汪","芒","枉","妄","惘","罔","辋","魍","尢"},
			ce={"策","测","册","侧","厕","恻"},
			nu={"女","努","怒","奴","弩","钕","驽","衄","孥","恧"},
			tan={"谈","探","坦","摊","弹","炭","坛","滩","贪","叹","谭","潭","碳","毯","瘫","檀","痰","袒","坍","忐","昙","郯","澹","钽","锬","镡"},
			kuang={"况","矿","框","狂","旷","眶","匡","筐","邝","圹","贶","夼","诳","诓","纩"},
			se={"色","塞","瑟","涩","啬","穑","铯"},
			shai={"色","筛","晒"},
			lie={"列","烈","劣","裂","猎","冽","咧","趔","洌","鬣","埒","捩","躐"},
			gang={"港","钢","刚","岗","纲","冈","杠","缸","扛","肛","罡","戆"},
			kuan={"款","宽","髋"},
			la={"拉","落","蓝","垃","腊","啦","辣","蜡","喇","剌","旯","砬","邋","瘌"},
			gu={"股","古","顾","故","固","鼓","骨","估","谷","贾","姑","孤","雇","辜","菇","沽","咕","呱","锢","钴","鹄","箍","汩","梏","痼","崮","鸪","牯","蛊","诂","毂","鹘","菰","罟","嘏","臌","觚","瞽","蛄","酤","牿"},
			gen={"根","跟","亘","艮","哏","茛"},
			tu={"土","突","图","途","徒","涂","吐","屠","兔","秃","凸","荼","钍","菟","堍","酴"},
			qun={"群","裙","逡"},
			su={"速","素","苏","诉","缩","塑","肃","俗","宿","粟","溯","酥","夙","愫","簌","稣","僳","谡","涑","蔌","嗉","觫"},
			lei={"类","累","雷","勒","泪","蕾","垒","磊","擂","镭","肋","羸","耒","儡","嫘","缧","酹","诔","檑"},
			xun={"讯","训","迅","寻","询","循","旬","巡","汛","勋","逊","熏","徇","浚","殉","驯","鲟","荤","薰","荀","浔","洵","峋","埙","巽","郇","醺","恂","窨","蕈","曛","獯"},
			zhua={"抓","挝"},
			re={"热","若","惹"},
			mi={"米","密","秘","迷","弥","蜜","谜","觅","靡","泌","眯","麋","猕","谧","咪","糜","宓","汨","醚","嘧","弭","幂","祢","縻","蘼","芈","糸","敉"},
			pei={"配","培","赔","佩","陪","沛","裴","胚","霈","旆","帔","呸","醅","辔"},
			kao={"考","靠","烤","拷","铐","栲","尻","犒"},
			duan={"断","段","短","端","锻","缎","煅","椴","簖"},
			luo={"落","罗","络","洛","逻","螺","锣","骆","萝","裸","漯","烙","摞","骡","咯","箩","珞","捋","荦","硌","雒","椤","镙","瘰","泺","脶","猡","蠃"},
			e={"额","俄","恶","鹅","遏","鄂","厄","饿","峨","扼","娥","鳄","蛾","噩","愕","讹","锷","垩","婀","鹗","萼","谔","莪","腭","锇","颚","呃","屙","轭"},
			shuang={"双","爽","霜","孀","泷"},
			rang={"让","壤","攘","嚷","瓤","穰","禳"},
			qie={"切","且","窃","茄","砌","锲","怯","伽","惬","妾","挈","郄","箧","慊"},
			pian={"便","片","篇","偏","骗","翩","扁","骈","胼","蹁","谝","缏"},
			kong={"空","控","孔","恐","倥","崆","箜"},
			ni={"你","尼","呢","泥","拟","尿","逆","倪","妮","腻","匿","霓","溺","旎","昵","坭","铌","鲵","怩","睨","祢","猊","慝"},
			ceng={"层","曾","蹭"},
			huang={"黄","荒","煌","皇","凰","慌","晃","潢","谎","惶","簧","璜","恍","幌","湟","蝗","磺","隍","徨","遑","肓","篁","鳇","蟥"},
			suan={"算","酸","蒜","狻"},
			po={"破","繁","坡","迫","颇","朴","泊","婆","泼","魄","粕","鄱","珀","陂","钹","叵","笸","泺","皤","钋"},
			tie={"铁","贴","帖","餮"},
			man={"满","慢","曼","漫","蔓","瞒","蛮","鳗","馒","幔","谩","熳","缦","镘","颟","墁","鞔"},
			ai={"爱","埃","艾","碍","癌","呆","哀","挨","矮","隘","蔼","唉","皑","哎","霭","捱","暧","嫒","嗳","瑷","嗌"},
			rong={"容","荣","融","绒","溶","蓉","熔","戎","榕","茸","冗","嵘","肜","狨","蝾"},
			chen={"称","陈","沈","沉","晨","琛","臣","尘","辰","衬","趁","忱","郴","宸","谌","碜","嗔","抻","榇","伧","谶","龀"},
			pai={"牌","排","派","拍","迫","徘","湃","俳","蒎"},
			cu={"促","粗","簇","醋","卒","蹴","猝","蹙","酢","蔟","殂","徂"},
			kun={"困","昆","坤","捆","琨","锟","鲲","髡","悃","阃"},
			chao={"超","朝","潮","炒","钞","抄","巢","吵","剿","绰","嘲","晁","焯","耖","怊"},
			sui={"随","岁","虽","碎","尿","隧","遂","髓","穗","绥","隋","邃","睢","祟","濉","燧","谇","眭","荽"},
			chun={"春","纯","醇","淳","唇","椿","蠢","鹑","莼"},
			kuo={"适","扩","括","阔","廓","栝","蛞"},
			hong={"红","宏","洪","轰","虹","鸿","弘","哄","烘","泓","訇","蕻","闳","讧","荭","黉","薨"},
			mai={"买","卖","麦","迈","脉","埋","霾","劢"},
			xiu={"修","秀","休","宿","袖","绣","臭","朽","锈","羞","嗅","岫","溴","庥","馐","咻","髹","鸺","貅"},
			qin={"亲","勤","侵","秦","钦","琴","禽","芹","沁","寝","擒","覃","噙","矜","揿","溱","芩","衾","廑","锓","吣","檎","螓"},
			cuo={"措","错","磋","挫","搓","撮","蹉","锉","厝","嵯","痤","矬","瘥","脞","鹾"},
			long={"龙","隆","弄","壟","笼","拢","聋","陇","胧","珑","窿","茏","咙","砻","垅","泷","栊","癃"},
			dun={"吨","顿","盾","敦","蹲","墩","囤","沌","钝","炖","盹","遁","趸","镦","礅"},
			kang={"康","抗","扛","慷","炕","亢","糠","伉","钪","闶"},
			pu={"普","暴","铺","浦","朴","堡","葡","谱","埔","扑","仆","蒲","曝","瀑","溥","莆","圃","璞","濮","菩","脯","蹼","匍","噗","氆","镨","镤"},
			reng={"仍","扔"},
			bo={"波","博","播","勃","拨","薄","伯","玻","搏","柏","泊","舶","剥","渤","魄","卜","驳","脖","膊","簸","菠","箔","掰","铂","亳","钵","帛","擘","饽","跛","钹","趵","檗","啵","鹁","孛","踣"},
			lan={"兰","览","蓝","篮","栏","岚","烂","滥","缆","揽","澜","拦","懒","榄","斓","婪","阑","褴","谰","镧"},
			piao={"票","朴","漂","飘","嫖","瓢","剽","缥","殍","瞟","骠","嘌","莩","螵"},
			sun={"损","孙","笋","荪","榫","隼","狲","飧"},
			ning={"宁","凝","苎","拧","泞","柠","咛","狞","佞","聍","甯"},
			ku={"苦","库","哭","酷","裤","枯","窟","骷","堀","刳","喾"},
			nao={"努","脑","闹","恼","挠","瑙","淖","孬","铙","呶","猱","蛲"},
			tao={"套","讨","陶","涛","逃","桃","萄","淘","掏","滔","韬","叨","焘","洮","啕","绦","饕","鼗"},
			song={"送","松","宋","讼","颂","耸","诵","嵩","淞","怂","悚","崧","忪","竦","菘"},
			mou={"某","谋","牟","缪","眸","哞","蝥","鍪","蛑","侔"},
			pa={"派","怕","帕","爬","扒","趴","琶","啪","葩","耙","杷","钯"},
			lue={"略","掠","锊"},
			hei={"黑","嘿"},
			chai={"差","拆","柴","钗","豺","侪","虿","瘥"},
			a={"阿","啊","呵","腌","嗄","锕"},
			ting={"听","庭","停","厅","廷","挺","亭","艇","婷","汀","铤","烃","霆","町","蜓","葶","梃","莛"},
			sha={"沙","厦","杀","纱","砂","啥","莎","杉","傻","煞","鲨","霎","嗄","痧","裟","挲","铩","唼","歃"},
			...
			han={"汉","韩","含","旱","寒","汗","涵","函","喊","憾","罕","焊","翰","邯","撼","瀚","憨","捍","酣","悍","阚","鼾","邗","颔","蚶","菡","顸","焓","撖"},
			...
			ka={"卡","喀","咖","咔","咯","佧"},
			qia={"卡","恰","洽","伽","掐","髂","袷"},
			qiao={"桥","乔","侨","巧","悄","敲","俏","壳","雀","蕉","瞧","翘","窍","峭","锹","撬","荞","跷","樵","憔","鞘","橇","峤","诮","谯","愀","硗","劁","缲"},
			fou={"否","缶"},
			bang={"帮","邦","榜","棒","膀","镑","绑","傍","磅","蚌","谤","梆","蒡"},
			...
			zen={"怎","谮"},
			kui={"亏","奎","愧","魁","馈","溃","匮","葵","窥","盔","逵","睽","馗","聩","喟","夔","篑","岿","揆","隗","傀","暌","跬","蒉","愦","悝"},
			ha={"哈","虾","蛤","铪"},
			za={"杂","扎","咱","砸","咋","匝","咂"},
			...
			rui={"瑞","锐","睿","芮","蕊","蕤","蚋","枘"},
			tang={"堂","唐","糖","汤","塘","躺","趟","倘","棠","烫","淌","膛","搪","镗","傥","螳","溏","帑","羰","樘","醣","螗","铴","瑭"},
			run={"润","闰"},
			kua={"跨","夸","垮","挎","胯","侉"},
			wa={"瓦","挖","娃","洼","袜","蛙","凹","哇","佤","娲","腽"},
			meng={"蒙","盟","梦","猛","孟","萌","氓","朦","锰","檬","懵","蜢","虻","蠓","艨","甍","艋","瞢","礞"},
			bin={"宾","滨","斌","彬","濒","殡","缤","鬓","槟","摈","膑","玢","镔","豳","髌","傧"},
			leng={"冷","愣","棱","楞"},
			peng={"鹏","朋","彭","膨","蓬","碰","棚","捧","烹","篷","澎","抨","硼","怦","砰","蟛","堋"},
			niu={"牛","纽","扭","钮","拗","妞","忸","狃"},
			rou={"肉","柔","揉","糅","鞣","蹂"},
			ruo={"若","弱","偌"},
			sen={"森"},
			...
			teng={"腾","疼","藤","滕","誊"},
			nin={"您"},
			miao={"苗","秒","妙","描","庙","瞄","缪","渺","淼","藐","缈","邈","杪","眇","喵"},
			mie={"灭","蔑","篾","乜","咩","蠛"},
			niang={"娘"},
			nai={"乃","奶","耐","奈","鼐","氖","柰","艿"},
			sang={"桑","丧","嗓","搡","颡","磉"},
			ca={"拆","擦","嚓","礤"},
			sao={"扫","骚","嫂","梢","缫","搔","瘙","臊","埽","缲"},
			zuan={"钻","赚","纂","攥","缵","躜"},
			shua={"刷","耍","唰"},
			gun={"滚","棍","辊","衮","鲧","绲"},
			guai={"怪","拐","乖"},
			...
			niao={"鸟","尿","溺","袅","茑","嬲"},
			die={"跌","疊","蝶","迭","碟","爹","谍","牒","耋","喋","踮","堞","瓞","鲽","垤","揲","蹀"},
			pen={"喷","盆","湓"},
			...
			diu={"丢","铥"},
			weng={"翁","嗡","瓮","蓊","蕹"},
			sou={"艘","搜","擞","嗽","嗖","叟","馊","薮","飕","嗾","溲","锼","瞍"},
			ga={"夹","嘎","尬","胳","噶","旮","尕","钆"},
			lia={"俩"},
			nen={"嫩","恁"},
			nang={"囊","囔","曩","攮"},
			nie={"聂","捏","涅","镍","孽","啮","蹑","嗫","臬","镊","颞","乜","陧"},
			beng={"泵","崩","蚌","蹦","迸","绷","甭","甏"},
			cou={"凑","辏","腠","楱"},
			pou={"剖","掊","裒"},
			seng={"僧"},
			nue={"虐"},
...
--
	...
	table.insert(bt,{str="←",x1=52*8,x2=0+50,y1=34*2,y2=0+32});
...
function IniName()
	local nm1 = {	"赵","钱","孙","李","周","吴","郑","王","冯","陈","褚","卫",
	...
	local nm2 = {	"忠","孝","礼","义","智","勇","仁","匡","宪","令","福","禄","大","小","晓","留","寻","家","一","不",
					"高","可","阿","金","世","克","叔","之","公","夫","时","若","庆","文","武","无","志","承","美","灵",
					"多","才","长","子","永","友","自","人","为","铁","顺","定","明","选","汉","延","双","祖","虎","平",
					"","","","","","","","","","","","","","","","","","","","","","","","","","","","","",
					"","","","","","","","","","","","","","","","","","","","","","","","","","","","","",};
	--For Sango, 不要三个字的
	nm2={"","","","","","","",""}
	local nm3 = {	"霸","白","班","斌","宾","昌","超","诚","川","鼎","定","斗","航","缺","过","菲","峰",
					"法","飞","风","锋","钢","罡","贯","光","海","虎","华","昭","捷","欢","宝","贤","誉",
					"浩","宏","济","坚","健","剑","江","进","杰","俊","康","芳","夫","浪","青","嘉","群",
					"良","麟","民","明","鸣","宁","培","启","强","荣","山","武","雨","鹰","甫","美","弃",
					"泰","涛","挺","伟","熙","祥","雄","旭","鹏","云","瑜","文","兰","靖","易","乔","冲",
					"毅","瑜","羽","宇","岳","舟","坤","东","齐","亮","英","笛","平","洛","志","玄","达",};
...
--[[ 备份，实际使用的版本会删减
	local HZ={
			...
			kuai={"会","快","块","筷","脍","蒯","侩","浍","郐","狯","哙"},
			gong={"工","公","共","供","功","红","贡","攻","宫","巩","龚","恭","拱","躬","弓","汞","蚣","珙","觥","肱"},
			jing={"经","京","精","境","竞","景","警","竟","井","惊","径","静","劲","敬","净","镜","睛","晶","荆","兢","靖","泾","憬","鲸","茎","腈","菁","胫","阱","旌","粳","靓","痉","儆","迳","婧","肼","刭","弪","獍"},
			...
			fang={"方","放","房","防","访","纺","芳","仿","坊","妨","肪","邡","舫","彷","枋","鲂","钫"},
			zhu={"主","术","住","注","助","属","逐","著","筑","驻","朱","珠","祝","猪","诸","柱","竹","铸","株","瞩","嘱","贮","煮","烛","褚","蛛","拄","铢","洙","竺","蛀","渚","伫","杼","侏","诛","茱","箸","炷","躅","翥","潴","邾","槠","舳","橥","瘃","麈","疰"},
			qi={"企","其","起","期","气","七","器","汽","奇","齐","启","旗","棋","妻","弃","歧","欺","骑","契","迄","亟","漆","戚","岂","稽","岐","琦","栖","缉","琪","泣","乞","砌","祁","崎","绮","祺","蹊","祈","凄","淇","杞","脐","麒","圻","岖","憩","芪","俟","畦","荠","耆","葺","沏","萋","骐","鳍","綦","讫","蕲","屺","颀","亓","碛","柒","汔","綮","萁","嘁","蛴","槭","欹","芑","桤","蜞"},
